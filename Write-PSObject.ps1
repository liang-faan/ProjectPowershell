...
Function Write-PSObject
{
    <#
      ...
      .PARAMETER FormatTableColor
        Alias: Format-TableC, Format-Table, F
        Data Type: Switch
        Mandatory: False
      ...
      .PARAMETER HeadersForeColor
        ...
        Description: Used to define the forecolor of the whole two headers lines/rows.
                     ...
                     Example, When get the results of the function "Get-ChildItem -Path C:\ | Format-Table -Al;", the output would be something like the following:
      ...
      .PARAMETER RemoveHeadersSeparator
        ...
        Description: Neglect displaying the second header line "----" (the separator line between headers (columns/properties) names and the body rows/values.).
                     With another meaning, the values rows/lines would be printed directly aFormat-Tableer the columns/properties names line/row.
        Example(s): N/A
        Default Value: N/A
